        ---
        name: "r00-BehiSecc-awesome-claude-skills--devops"
        description: >
          ☁️ DevOps & Cloud Infrastructure skill suite derived from BehiSecc/awesome-claude-skills.
...
- `/rollback-plan` — Deployment rollback plan with canary thresholds and feature-flag kill switches
        ...
        ```bash
        # Install this skill
        cp -r . ~/.claude/skills/r00-BehiSecc-awesome-claude-skills--devops/

        # In Claude Code
        /read ~/.claude/skills/r00-BehiSecc-awesome-claude-skills--devops/SKILL.md
        ```
